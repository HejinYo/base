    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<%=basePath %>resources/documentation/index.html"><i class="fa fa-book"></i> <span>文档</span></a></li>
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <section class="col-lg-7 connectedSortable">
                    <!-- Custom tabs (Charts with tabs) 自定义标签（带标签的图表）-->
                    <div class="nav-tabs-custom">
                        <!-- Tabs within a box 一个框内的标签 -->
                        <ul class="nav nav-tabs pull-right">
                            <li class="active"><a href="#revenue-chart" data-toggle="tab">区域</a></li>
                            <li><a href="#sales-chart" data-toggle="tab">甜甜圈</a></li>
                    ...
                    <div class="box box-primary">
                      ...
                      <span class="handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <input type="checkbox" value="">
                                    <span class="text">使主题响应</span>
                                    <small class="label label-info"><i class="fa fa-clock-o"></i> 4 个小时</small>
                                    <div class="tools">
                                        <i class="fa fa-edit"></i>
                                        <i class="fa fa-trash-o"></i>
                                    </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <input type="checkbox" value="">
                                    <span class="text">让主题像一颗星星闪闪发光</span>
                                    <small class="label label-warning"><i class="fa fa-clock-o"></i> 1天</small>
                                    <div class="tools">
                                        <i class="fa fa-edit"></i>
                                        <i class="fa fa-trash-o"></i>
                                    </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <input type="checkbox" value="">
                                    <span class="text">让主题像一颗星星闪闪发光</span>
                                    <small class="label label-success"><i class="fa fa-clock-o"></i> 3天</small>
                                    <div class="tools">
                                        <i class="fa fa-edit"></i>
                                        <i class="fa fa-trash-o"></i>
                                    </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <small class="label label-primary"><i class="fa fa-clock-o"></i> 1周</small>
                                    <div class="tools">
                                        <i class="fa fa-edit"></i>
                                        <i class="fa fa-trash-o"></i>
                                    </div>
                      ...
                      <span class="handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <input type="checkbox" value="">
                                    <span class="text">让主题像一颗星星闪闪发光</span>
                                    <small class="label label-default"><i class="fa fa-clock-o"></i> 1个月</small>
                                    <div class="tools">
                                        <i class="fa fa-edit"></i>
                                        <i class="fa fa-trash-o"></i>
                                    </div>
                        ...
                        <div class="box-footer clearfix no-border">
                            <button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> 新增项目</button>
                        </div>
                    </div>
                    <!-- /.box -->
                ...
                <!-- /.Left col -->
                <!-- right col 右侧边的列(We are only adding the ID to make the widgets sortable 我们只是添加ID来使小部件可排序)-->

<%@page import="com.hejinyo.core.common.utils.PageParam"%>
...
<link rel="stylesheet" type="text/css" href="/sources/css/ip/index.min.css">
</head>
<body>
	...
	<div id="page-header" class="wrap header">
		<header id="masthead" class="site-header" data-role="banner">
			<div class="hgroup">
				<h1 class="site-title">
					<a class="home-link" href="${basePath }" title="代理IP提取系统" rel="home"d>代理IP提取系统</a>
				</h1>

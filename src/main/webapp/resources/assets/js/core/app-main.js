...
var Main = function() {
	...
	var sidebarHandler = function() {
		...
		elem.on('click', 'a', function(e) {
			...
			if(_this.next().is('ul') && _this.parent().toggleClass('open')) {//折叠和打开多级菜单
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "resources/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "resources/assets/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "resources/assets/images/core/logo2.png");
					break;

				default:
					$(".navbar-brand img").attr("src", "resources/assets/images/core/logo.png");
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "resources/assets/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "resources/assets/images/core/logo.png");
    ...
    var goTopHandler = function(e) {
        ...
        $('#app').append(slideToTop);

        var frameWidow = document.getElementById('main-iframe').contentWindow;
        $(frameWidow).scroll(function () {
            if ($(frameWidow).scrollTop() >= 150) {
        ...
        $(slideToTop).click(function (e) {
            $(frameWidow.document.body).animate({
                scrollTop: 0
            }, "slow");
            e.preventDefault();
        });
    ...
    function resizeIframeHeight() {
        // HejinYo ifram 自适应高度
        $('#main-iframe').height($(window).height() - $('.navbar-header').outerHeight(true)-$('footer').outerHeight(true));
    }

 ...
 */
	...
	$.jstree.core.prototype = {
		 ...
		 * @trigger pojo.jstree, changed.jstree
		 */
		_append_html_data : function (dom, data, cb) {
			...
			/**
			 * triggered when new data is inserted to the tree pojo
			 * @event
			 * @name model.jstree
		...
		/**
		 * parses a node from a jQuery object and appends them to the in memory tree pojo. Used internally.
		 * @private
		 * @name _parse_model_from_html(d [, p, ps])
		 * @param  {jQuery} d the jQuery object to parse
		 * @param  {String} p the parent ID
		 * @param  {Array} ps list of all parents
		 * @return {String} the ID of the object added to the pojo
		 */
		...
		/**
		 * parses a node from a JSON object (used when dealing with flat data, which has no nesting of children, but has id and parent properties) and appends it to the in memory tree pojo. Used internally.
		 * @private
		...
		/**
		 * parses a node from a JSON object and appends it to the in memory tree pojo. Used internally.
		 * @private
		...
		set_id : function (obj, id) {
			...
			// update pojo and obj itself (obj.id, this._model.data[KEY])
		 ...
		 * @trigger pojo.jstree, create_node.jstree
		 */
		 ...
		 * @param  {Boolean} skip_redraw internal parameter indicating if the tree should be redrawn
		 * @param  {Boolean} instance internal parameter indicating if the node comes from another instance
		 * @trigger pojo.jstree copy_node.jstree
		 */

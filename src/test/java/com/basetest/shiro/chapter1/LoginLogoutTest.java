...
public class LoginLogoutTest {
    private static org.apache.logging.log4j.Logger logger = LogManager.getLogger(TestShiro.class.getName());

    @Test
    public void testHelloworld() {
        //1、获取SecurityManager工厂，此处使用Ini配置文件初始化SecurityManager
        Factory<org.apache.shiro.mgt.SecurityManager> factory =
                new IniSecurityManagerFactory("classpath:shiro/shiro01.ini");
    ...
    public void testCustomRealm() {
        //1、获取SecurityManager工厂，此处使用Ini配置文件初始化SecurityManager
        Factory<org.apache.shiro.mgt.SecurityManager> factory =
                new IniSecurityManagerFactory("classpath:shiro/shiro02.ini");
    ...
    public void testAllSuccessfulStrategyWithSuccess() {
        ...
        logger.error(principalCollection.asList());
    }
